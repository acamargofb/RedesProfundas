...
# Define the Inception module with Batch Normalization
...
# Define the GoogLeNet architecture with Batch Normalization
...
# The training, testing, and main loop remain the same as in your original code.
