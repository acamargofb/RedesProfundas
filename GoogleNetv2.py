# -*- coding: utf-8 -*-
"""
Created on Sat May 18 14:30:24 2024
...
if __name__ == '__main__':
    x = torch.randn(1, 3, 224, 224)  # Batch size of 1, 3 color channels, and image size 224x224
    model = GoogleNet()
    out = model(x)  # Perform a forward pass with the model
    print(out.shape)  # Print the shape of the output (should be [1, 1000] for 1000 classes)
